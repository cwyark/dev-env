...
complete -c dev-env -n '__dev_env_needs_command' -a install -d 'Install config and tools'
complete -c dev-env -n '__dev_env_needs_command' -a update -d 'Upgrade mise-managed tools'
...
complete -c dev-env -n '__dev_env_needs_command' -a zellij -d 'Start zellij or attach to a session'
